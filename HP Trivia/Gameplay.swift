...
//  HP Trivia
//
//  Created by mohammed sholaja on 12/25/24.
//
            ...
            ZStack {
                        ...
                        VStack {
                            if animateViewsIn {
                                Image(systemName: "questionmark.app.fill")
                                    ...
                                    .onAppear {
                                        withAnimation(.easeInOut(duration: 0.05).repeatCount(7).delay(5).repeatForever()) {
                                            hintWiggle = true
                                        }
                                    }
                                    .onTapGesture {
                                    ...
                                    .scaleEffect(revealHint ? 5 : 1) // If revealHint is true, scale up 5 times; if it's false, keep it the same
                        ...
                        VStack {
                            if animateViewsIn {
                                Image(systemName: "book.closed")
                                    ...
                                    .scaleEffect(revealBook ? 5 : 1) // If revealHint is true, scale up 5 times; if it's false, keep it the same
                                ...
                                VStack {
                                    if animateViewsIn {
                                        if tappedCorrectAnswer == false {
                                            Text(answer)
                                                .minimumScaleFactor(0.5) //Causes the text to get smaller to make it all fit
                                                .multilineTextAlignment(.center)
                                                .padding(10)
                                ...
                                VStack {
                                    if animateViewsIn {
                                        Text(answer)
                                            ...
                                            .padding(10)
                                            .frame(width: geo.size.width/2.5, height: 80)
                                            .background(wrongAnswersTapped.contains(i) ?  .red.opacity(0.3) : .green.opacity(0.5))
                                            .cornerRadius(15)
                                            .transition(.scale)
                ...
                VStack {
                    ...
                    VStack {
                        if tappedCorrectAnswer {
                            Text("Brilliant!")
                                .font(.custom(Constants.hpFont, size: 75))
                    ...
                    VStack {
                        if tappedCorrectAnswer {
                            Button("Next Level >") {
                                ...
                                DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) { animateViewsIn = true
                                }
                            }
                            .buttonStyle(.borderedProminent)
