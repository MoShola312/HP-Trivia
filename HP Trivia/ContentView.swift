        ...
        GeometryReader { geo in
            ZStack{
                Image("hogwarts")
                    ...
                    .onAppear { withAnimation(.linear(duration: 60).repeatForever()){
                            ...
                            if animateViewsin {
                                ...
                                .fullScreenCover(isPresented: $playGame){
                                    Gameplay()
                                        ...
                                        .onAppear{ audioPlayer.setVolume(0, fadeDuration: 2)
                                        }
                                        .onDisappear { audioPlayer.setVolume(1, fadeDuration: 3)
                                        }
                                }
